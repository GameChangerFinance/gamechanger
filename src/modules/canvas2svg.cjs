/*!!
 *  Canvas 2 Svg for EasyQRCodeJS-NodeJS
...
;(function () {
  ...
  ctx = function (o) {
    ...
    // this.__root.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:xlink",
  ...
  ctx.prototype.getSerializedSvg = function (fixNamedEntities) {
    var serialized = new this.XMLSerializer().serializeToString(this.__root),
      keys,
      i,
      key,
      value,
